...
set ILMergeSolution=%1\packages\ILMerge.2.14.1208\tools\ILMerge.exe
...
rem #    run merge cmd
@echo Merging: '"%ILMerge%" /alllowDup /wildcards /targetplatform:%net% /out:"%result%" %target_path% "%target_dir%*.dll"'
